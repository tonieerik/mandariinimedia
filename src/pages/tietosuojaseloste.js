  ...
  <div className="bg-white">
    <div className="max-w-4xl mx-auto py-10 px-4 sm:py-24 sm:px-6 lg:px-8 text-sm">
      ...
      <div className="mt-12 text-gray-500">
        ...
        kerromme, kuinka käsittelemme asiakkaidemme henkilötietoja. Asiakkaan on
        hyväksyttävä tietosuojaselosteen ehdot käyttääkseen Mandariinimedian
      ...
      <div className="mt-4 text-gray-500">
        ...
        <p className="mt-2">
          ...
          kautta. Tallennamme myös tietoja, joita olemme saaneet sähköpostitse,
          puhelimitse, sosiaalisen median kanavien kautta, sopimuksista,
          asiakastapaamisista ja muista tilanteista, joissa asiakas luovuttaa
          tietojaan. Jos olet potentiaalisen yrityksen edustaja, saatamme kerätä
          tietosi julkisesti verkossa, esimerkiksi yrityksesi verkkosivuilta.
        </p>
      </div>
      <div className="mt-4 text-gray-500">
      ...
      <div className="mt-4 text-gray-500">
        ...
        <p className="mt-2">
          Käsittelemme tietoja vain niin kauan kuin tarvitsemme niitä rekisterin
          tarkoituksen mukaisessa toiminnassa. Voit pyytää tietojesi poistamista
          rekisteristä lähettämällä pyynnön sähköpostitse osoitteeseen
          nelli@mandariinimedia.fi.
        </p>
      </div>
      <div className="mt-4 text-gray-500">
        ...
        <p className="mt-2">
          Huolehdimme tarvittavista turvatoimista, etteivät henkilötietosi joudu
          vääriin käsiin. Käsittelemme henkilötietoja vain tietoturvallisiksi
          todetuilla tietojärjestelmillä, jotka vastaavat tyypillisimpiin
          tietoturvariskeihin. Rajaamme pääsyn tietoihin vain niille
          henkilöille, jotka ovat siihen oikeutettuja.
        </p>
      </div>
      <div className="mt-4 text-gray-500">
        <h2 className="font-semibold">
        ...
        <p className="mt-2">
          ...
          Security Terms 2.0). Palvelun käyttö perustuu asetus (EU) 2016/679, 22
          § mukaisesti palveluntoimittajan Privacy Shield- sertifikaattiin.
        </p>
      </div>
      <div className="mt-4 text-gray-500">
        <h2 className="font-semibold">
      ...
      <div className="mt-4 text-gray-500">
        ...
        <p className="mt-2">
          ...
          käyttäjäystävällisemmiksi. Evästeiden avulla kerättävillä tiedoilla ei
          voida tunnistaa yksittäisiä käyttäjiä. Edellytämme, että hyväksyt
        ...
        <p className="mt-2">
          Evästeistä voi kieltäytyä. Huomaa, että evästeistä kieltäytyminen voi
          tietyissä tapauksissa johtaa toimintojen teknisiin rajoituksiin
          verkkosivuillamme.
        </p>
        <p className="mt-2">
          Useimpien selainohjelmien Ohje-valikosta saat tietoa siitä, miten
          selaintasi estetään hyväksymästä uusia evästeitä, miten saat selaimesi
          ilmoittamaan uuden evästeen vastaanottamisesta tai miten estät
          evästeiden käytön kokonaan. Lisäksi voit poistaa käytöstä tai tuhota
          vastaavanlaiset tiedot, joita selaimien lisäosat voivat käyttää,
          muuttamalla lisäosan asetuksia tai käymällä sen valmistajan
      ...
      <div className="mt-4 text-gray-500">
        ...
        <p className="mt-2">
          ...
          kanssa – mukaan lukien vuorovaikutuksen seuranta, jos olet kirjautunut
          käyttäjänä sivustolle.
        </p>
      </div>
    </div>
  </div>
